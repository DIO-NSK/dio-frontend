  ...
  return (
    <div className={cn(wrapperCV)}>
      <Text
        ...
        className={
          "px-5 sm:px-0 w-full text-[22px] sm:col-span-6 md:text-[28px] sm:text-[32px] font-semibold text-link-blue"
        }
      />
      <Text
        className={"px-5 sm:px-0 w-full text-[16px] sm:col-start-8 sm:col-span-5 xl:text-[18px] text-black"}
        text={
          "Для удобства пользования 19-литровыми бутылями предлагается" +
