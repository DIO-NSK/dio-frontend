  ...
  return (
    <div className={cn(wrapperCV)}>
      <div className={"w-full sm:col-span-6 flex flex-col gap-[20px]"}>
        ...
        <Text
          className={
            "text-[16px] md:text-[18px] lg:text-[20px] xl:text-[22px] xl:pb-5 border-b-2 border-light-gray sm:border-0"
          }
          text={
            "С 2001 года мы занимаемся производством, розливом\n" +
        ...
        <Text
          ...
          text={
            "Главный принцип производства питьевой воды «DIO»  — сохранение\n" +
      ...
      <div className={"w-full sm:col-start-8 sm:col-span-5 flex flex-col md:gap-4 xl:gap-5"}>
        ...
        <Text
          ...
          text={
            "Артезианская вода «DIO» производится на полностью автоматической" +
