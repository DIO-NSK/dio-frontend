...
const MobileMenuPage = () => {
    ...
    const handleTabClick = (link : string) => router.push(link)

    const menuTabData: IconTextAction[] = [
        {icon: <FiLogIn className={"text-link-blue"}/>, text: "Войти", action: () => console.log("Test")},
        {icon: <FiMenu className={"text-link-blue"}/>, text: "Каталог", action: () => handleTabClick("/catalog/1")},
