...
const AddOurWaterPopup = (props: PopupProps) => {
  ...
  const [ourWaterToEdit, setOurWaterToEdit, createOurWater, editOurWater, editStatus] = useUnit([
    $ourWaterToEdit,
    setOurWaterToEditEvent,
    createOurWaterFx,
    submitOurWaterEvent,
    ...
    <PopupWrapper onClose={handleClose}>
      <FormProvider {...methods}>
        ...
        <Form className={"w-[800px] flex flex-col gap-5"}>
          <Text
            text={ourWaterToEdit ? "Редактирование карточки" : "Новая карточка"}
          ...
          <PopupBlock
            ...
            description={
              "Выберите фотографию без фона. Данная фотография будет отображаться на главной странице в разделе «Наши воды»"
            }
          >
