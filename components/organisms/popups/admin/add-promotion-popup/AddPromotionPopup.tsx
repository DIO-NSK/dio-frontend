...
const repsonsiveImages = [
  ...
  {
    name: "imageUrlDto.tabletHorizontalImageUrl",
    header: "Для горизонтальных планшетов",
    extension: "Размер 556x290px",
  },
...
const AddPromotionPopup = (props: PopupProps) => {
  ...
  const [promotionToEdit, setPromotionToEdit, createPromotion, editPromotion] = useUnit([
    $promotionToEdit,
    setPromotionToEditEvent,
    createPromotionFx,
    editPromotionEvent,
    ...
    <PopupWrapper onClose={handleClose}>
      <FormProvider {...methods}>
        ...
        <Snackbar
          ...
          header={
            editPromotionStatus
              ? "Промо-акция отредактирована успешо!"
              : "Возникли ошибки при редактировании промо-акции"
          }
        ...
        <Form className={"w-[800px] flex flex-col gap-5"}>
          ...
          <PopupBlock header={"Фотография промо-акции"} className="grid grid-cols-2 gap-5">
            ...
            {methods.formState.errors["imageUrlDto"] ? (
              <Text className="text-info-red" text="Все фотографии должны быть загружены" />
            ) : null}
          </PopupBlock>
          <Button
