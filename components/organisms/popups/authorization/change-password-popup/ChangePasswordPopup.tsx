...
import { useChangePasswordPopup } from "@/components/organisms/popups/authorization/change-password-popup/ChangePasswordPopup.hooks";
    ...
    <PopupWrapper>
      <FormProvider {...methods}>
        <div className={"w-[450px] rounded-xl bg-white flex flex-col gap-5"}>
          <Text text={"Новый пароль"} className={"text-[20px] font-medium"} />
          <ControlledTextInput
          ...
          <div className={"w-full flex flex-col gap-3"}>
            ...
            />
            <Button onClick={context.handleLogin} buttonType={"SECONDARY"} text={"Войти заново"} />
          </div>
        </div>
      </FormProvider>
    </PopupWrapper>
