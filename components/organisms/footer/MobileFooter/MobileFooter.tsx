  ...
  return (
    <section className={"mobileFooterRow flex-row items-center justify-between"}>
      <div className={"flex flex-col gap-1"}>
        <Text text={"Заказать звонок"} className={"text-link-blue font-medium"} onClick={handleOrderCallRequest} />
        <Link href={"tel:+733339900"}>
          <Text className={"text-link-blue text-[14px]"} text={"+7 (383) 333-99-00"} />
        </Link>
      </div>
      <IconRow />
    </section>
