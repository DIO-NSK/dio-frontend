...
const OurWaterPageCard = ({ ourWater }: OurWaterPageCardProps) => (
  <Link href={`/our-waters/category/${ourWater.id}`} className={cn(wrapperCV)}>
    <img className={"w-[100px] h-[100px] rounded-xl object-scale-down"} alt={ourWater.name} src={ourWater.image} />
