...
const maintenanceGroup : Group<ServiceCardDTO> = {
    ...
    items : [
        ...
        },
        {
            ...
            descr : `Настольный кулер с нагревом и охлаждением предоставляется в бесплатное пользование при условии ежемесячного заказа не менее 8-ми бутылей по 19 литров питьевой воды dio`,
            additional : [
                "Обязательным условием бесплатного пользования кулеров является проведение платной санитарной обработки оборудования 1 раз в шесть месяцев, в сервисном центре Компании \"DIO\"",
                "При невыполнении ежемесячного плана потребления питьевой воды DIO, вы будете обязаны оплатить арендную плату за каждый месяц нарушения условий договора."
            ],
        ...
        {
            header : "Напольный кулер в бесплатное пользование",
            descr : `Напольный кулер с нагревом и охлаждением предоставляется в бесплатное пользование при условии ежемесячного заказа не менее 10-ти бутылей по 19 литров питьевой воды dio`,
            additional : [
                "Обязательным условием бесплатного пользования кулеров является проведение платной санитарной обработки оборудования 1 раз в шесть месяцев, в сервисном центре Компании \"DIO\"",
                "При невыполнении ежемесячного плана потребления питьевой воды DIO, вы будете обязаны оплатить арендную плату за каждый месяц нарушения условий договора."
            ],
