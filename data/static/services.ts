  ...
  items: [
    {
      ...
      descr:
        "Аренда может осуществляться как на краткосрочной основе, так и на длительный период. Напольный кулер с нагревом и охлаждением и с холодильником на 16 литров:",
      rentTime: [
        { name: "До недели", value: "750 ₽" },
        { name: "Помесячная аренда", value: "800 ₽" },
        { name: "6 месяцев", value: "4600 ₽ за весь срок" },
        { name: "1 год", value: "8800 ₽ за весь срок" },
      ],
      additional: [
    ...
    },
    {
      ...
      descr:
        "Аренда может осуществляться как на краткосрочной основе, так и на длительный период. Напольный кулер с нагревом и охлаждением.",
      rentTime: [
        { name: "До недели", value: "650 ₽" },
        { name: "Помесячная аренда", value: "700 ₽" },
        { name: "6 месяцев", value: "4000 ₽ за весь срок" },
        { name: "1 год", value: "7600 ₽ за весь срок" },
      ],
      additional: [
        "Доставка и установка кулера",
        "Сервисное обслуживание и ремонт неисправностей, возникших не по вине клиента",
    ...
    },
    {
      ...
      rentTime: [
        ...
        { name: "6 месяцев", value: "2500 ₽ за весь срок" },
        { name: "1 год", value: "2500 ₽ за весь срок" },
      ],
      additional: [
        "Доставка и установка кулера",
        "Сервисное обслуживание и ремонт неисправностей, возникших не по вине клиента",
    ...
    },
    {
      ...
      descr:
        "Сервисное обслуживание пурифайеров проводится на месте его установки, без демонтажа и замены! Минимальный срок аренды — 1 месяц.",
      rentTime: [
        { name: "1 месяц", value: "2500 ₽" },
        { name: "3 месяца", value: "5800 ₽" },
        { name: "6 месяцев", value: "14 500 ₽" },
        { name: "1 год", value: "28 000 ₽" },
      ],
      additional: [
        "Доставка пурифаера",
    ...
    },
    {
      ...
      descr:
        "Сервисное обслуживание пурифайеров проводится на месте его установки, без демонтажа и замены! Минимальный срок аренды — 1 месяц.",
      rentTime: [
        { name: "1 месяц", value: "2700 ₽" },
        { name: "3 месяца", value: "5800 ₽" },
        { name: "6 месяцев", value: "15 500 ₽" },
        { name: "1 год", value: "30 000 ₽" },
      ],
      additional: [
        "Доставка пурифаера",
        "Установка и подключение к системе водоснабжения до 10 метров без скрытой установки",
  ...
  items: [
    {
      ...
      additional: ["Трубка полипропиленовая до 10 м", "Кабель канал до 6 м", "Кран ц/ц", "Кран врезной"],
    ...
    },
    {
      ...
      additional: ["Трубка полипропиленовая до 20 м", "Кабель канал до 10 м", "Кран ц/ц", "Кран врезной"],
